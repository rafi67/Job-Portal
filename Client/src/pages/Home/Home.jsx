...
const Home = () => {
    return (
        <>
            ...
            <section className="max-w-7xl mx-auto px-4 lg:px-0 py-32">
                <div className="flex justify-between items-center mb-10">
                    <h2 className="text-4xl font-medium">Explore by <span className="text-blue-400">category</span></h2>
                ...
                <div className="grid grid-cols-4 gap-10">
                    <div className="border border-gray-500 p-7 rounded-xl">
                        ...
                        <h3 className="font-medium text-3xl mb-4">Business</h3>
                        <a href="#" className="flex space-x-2 items-center hover:text-blue-500">
